...
export const projectService = new ProjectService(projectRepository, roomRepository, subscriptionRepository, userSubscriptionRepository, roomService, discoverRepository);
...
export const discoverService = new DiscoverService(discoverRepository, projectRepository, userSubscriptionRepository)
...
export const adminController = new AdminController(userService, projectService, paymentService, userSubscriptionService)
